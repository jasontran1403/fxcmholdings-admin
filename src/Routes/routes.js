...
import AccountTable from "../Pages/Tables/AccountTables/Accounts";
import InvestmentTable from "../Pages/Tables/InvestmentTables/Investments";
import TransactionTable from "../Pages/Tables/TransactionTables/Transaction";
import DepositTable from "../Pages/Tables/DepositTables/Deposits";
...
const authProtectedRoutes = [
  ...
  // Calender
  { path: "/investments", component: <InvestmentTable /> },

  // Calender
  { path: "/transactions", component: <TransactionTable /> },

  // Calender
  { path: "/deposit", component: <DepositTable /> },

  // Calender
  { path: "/withdraw", component: <WithdrawTable /> },

  // Calender
  { path: "/kyc", component: <KycTable /> },

  // Calender
  { path: "/packages", component: <PackageTable /> },

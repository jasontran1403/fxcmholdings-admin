...
const FormValidations = () => {
  document.title = "Form Validation | FXCM Holdings - Admin Dashboard";
  // Form validation
  ...
  const rangeValidation = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      range_length: Yup.string()
        ...
        .matches("This value should be Greater than or equal to 6."),
                  ...
                  >
                    ...
                    <div className="mb-3">
                      ...
                      <Input
                        ...
                        onChange={validationType.handleChange}
                        onBlur={validationType.handleBlur}
                        value={validationType.values.urls || ""}
                        invalid={
                          validationType.touched.urls &&
                            validationType.errors.urls
                            ? true
                            : false
                        }
                      />
